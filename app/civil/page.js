...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={2} footerStyle={1} breadcrumbTitle="Civil Works">
                    ...
                    <div className="col-xl-8">
                        <div className="services-details__content">
                            ...
                            <div className="services-details__content-text1">
                                <h2>Our Civil Works Services Include :-</h2>
...
<div className="col-xl-12 col-lg-6 col-md-6">
                                        <div className="services-details__content-text3-list">
                                            <ul>
                                                   ...
                                                   <pre></pre>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Foundation works (pile, raft, isolated footings)</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;RCC framing and concrete structures</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Steel structures and fabrication</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Retaining walls and boundary walls
</p>
                                                </li>
                                            ...
                                            <ul>
                                                   ...
                                                   <pre></pre>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Land grading and leveling</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Road construction and paving</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Drainage and stormwater systems</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Earthworks and excavation
</p>
                                                </li>
                                ...
                                <div className="row">
                                    <div className="col-xl-6 col-lg-6 col-md-6">
                                        <div className="services-details__content-img2-single">
                                            <img src="assets/images/allimg/civil/civil2.webp" alt=""/>
                                        </div>
                                    </div>
                                    <div className="col-xl-6 col-lg-6 col-md-6">
                                        <div className="services-details__content-img2-single">
                                            <img src="assets/images/allimg/civil/civil3.webp" alt=""/>
                                        </div>
                                    </div>
                            ...
                            <div className="col-xl-12 col-lg-6 col-md-6">
                                   <h2>
Masonry & Finishing Works</h2><pre></pre>
                                        <div className="services-details__content-text3-list">
                                            
                                            <ul>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Blockwork and brick masonry</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Plastering, tiling & flooring</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Painting and waterproofing</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Interior and exterior finishing</p>
                                                </li>
                                            ...
                                            <br/>
                                              <ul>
                                                    <h2>
Masonry & Finishing Works</h2>
<br/>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Factory shed & warehouse construction</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Utility trenches and cable duct works</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Compound walls & fencing</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;RCC tanks & manholes</p>
                                                </li>
...
<br/>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Experienced Civil Engineers & Supervisors</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;End-to-End Project Management</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Quality Materials & Skilled Workforce</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Timely Completion & Transparent Process</p>
                                                </li>
                                                <li>
                                                    <p><span className="icon-verified"></span>&nbsp;&nbsp;Safety-Compliant and Cost-Effective</p>
                                                </li>
                        ...
                        <div className="sidebar">
                            ...
                            <div className="sidebar__single sidebar__services wow fadeInUp" data-wow-delay=".1s">
                                ...
                                <ul className="sidebar__services-list">
                                    ...
                                    <li><Link href="Engineering">Engineering Design Services<span
                                                className="icon-right-arrow"></span></Link>
                                    </li>
                                    <li className="active"><Link href="civil">Civil Works<span
                                                className="icon-right-arrow"></span></Link>
                                    </li>
                                </ul>
                            </div>
